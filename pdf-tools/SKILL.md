---
name: pdf-tools
description: "PDF creation, editing, extraction, forms, OCR, redaction, and rendering. Use when working with PDF files: creating reports with ReportLab, extracting text/tables, filling forms, redacting content, converting documents to PDF, or performing visual QA on PDF output."
---
...
```bash
python skills/pdf-tools/scripts/render_pdf.py input.pdf --out_dir files/_renders/in --dpi 200
```
...
```bash
python skills/pdf-tools/scripts/compare_renders.py before.pdf after.pdf --out_dir files/_diff --dpi 200
```
