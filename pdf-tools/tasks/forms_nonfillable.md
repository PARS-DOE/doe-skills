...
```bash
python skills/pdf-tools/scripts/render_pdf.py input.pdf --out_dir files/_renders/in --pages 1 --dpi 200
open files/_renders/in/page-1.png
```
...
```bash
python skills/pdf-tools/scripts/box_picker_html.py input.pdf --page 1 --dpi 200 --out files/box_picker.html
```
...
```bash
python skills/pdf-tools/scripts/place_text_by_boxes.py input.pdf spec.json values.json \
  --out files/_tmp/stamped.pdf \
  --preview_pdf files/_tmp/preview.pdf

python skills/pdf-tools/scripts/render_pdf.py files/_tmp/preview.pdf --out_dir files/_renders/preview --pages 1
open files/_renders/preview/page-1.png
```
...
```bash
python skills/pdf-tools/scripts/render_pdf.py files/_tmp/stamped.pdf --out_dir files/_renders/out --pages 1
