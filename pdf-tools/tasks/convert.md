...
```bash
python skills/pdf-tools/scripts/lo_convert_to_pdf.py input.docx --out_dir files/out
```
...
```bash
python skills/pdf-tools/scripts/html_to_pdf.py input.html -o files/out.pdf --format letter
```
...
```bash
python skills/pdf-tools/scripts/md_to_pdf.py input.md -o files/out.pdf --pdf_engine xelatex
```

## LaTeX -> PDF

```bash
python skills/pdf-tools/scripts/latex_to_pdf.py input.tex -o files/out.pdf
```
