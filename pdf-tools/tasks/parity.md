...
```bash
python renderer_parity.py input.pdf --out_dir files/_parity --dpi 200
```

Open:
- `files/_parity/render_pdftoppm/page-*.png`
- `files/_parity/render_pdfium/page-*.png`
- `files/_parity/diff/page-*.png` (only for pages with changes)
