...
Golden path:
  python box_picker_html.py input.pdf --page 1 --dpi 200 --out files/box_picker.html
...
def main() -> int:
    ...
    p.add_argument("--tmp_dir", default="files/_box_picker", help="Temp render directory")
    args = p.parse_args()
