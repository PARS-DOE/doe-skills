...
Examples:
  python pdf_extract.py text input.pdf --method pdfplumber --out files/text.txt
  python pdf_extract.py words input.pdf --out words.csv
  python pdf_extract.py tables input.pdf --out_dir files/tables --format xlsx
  python pdf_extract.py images input.pdf --out_dir files/images
