...
Examples:
  python latex_to_pdf.py main.tex --out_dir files/out
  python latex_to_pdf.py main.tex --out_dir files/out --engine xelatex
  python latex_to_pdf.py main.tex -o files/out.pdf --engine xelatex
