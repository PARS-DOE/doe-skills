...
Golden path:
  python compare_renders.py a.pdf b.pdf --out_dir files/_diff --dpi 200

Outputs:
  - files/_diff/summary.json
  - files/_diff/diff/page-<N>.png (only for changed pages)
  - files/_diff/render_a/... and files/_diff/render_b/... (renders)
