...
Examples:
  python create_montage.py files/_renders/input --out files/montage.png
  python create_montage.py files/_renders/input/page-*.png --out files/montage.png --cols 4
