...
Usage:
  python redact_smoketest.py  # writes to files/_pdf_redact_smoke
  python redact_smoketest.py --workdir files/_pdf_redact_smoke_custom
"""
...
def main() -> int:
    ...
    ap.add_argument("--workdir", default="files/_pdf_redact_smoke")
