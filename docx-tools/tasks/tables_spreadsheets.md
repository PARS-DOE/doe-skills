...
```bash
python scripts/xlsx_to_docx_table.py files/input.xlsx files/table.docx --title "Table: Results"
```
...
```bash
python scripts/docx_table_to_csv.py files/input.docx --table_index 0 --out files/table0.csv
```
